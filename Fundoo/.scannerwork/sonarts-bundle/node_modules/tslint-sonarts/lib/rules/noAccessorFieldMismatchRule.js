...
class Walker extends tslint.ProgramAwareRuleWalker {
    ...
    visitAccessor(accessor, setterOrGetter) {
        ...
        if (containingStructure.kind === ts.SyntaxKind.ObjectLiteralExpression) {
            ...
            matchingField = Walker.matchingField(containingStructure.members, Walker.fieldsDeclaredInConstructorParameters(containingStructure), setterOrGetter.name);
    ...
    static matchingField(members, constructorDeclaredParameters, targetName) {
        return members
